...
Button(frame, text="9").grid(row=0, column=2, padx=0, pady=0)

Button(frame, text="4 ").grid(row=1, column=0, pady=10)
Button(frame, text="5").grid(row=1, column=1, ipadx=-1, ipady=-5, padx=10, pady=10)
